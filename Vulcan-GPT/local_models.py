...
class LocalModelManager:
    ...
    def download_model(self, model_url, model_name=None):
        ...
        target_path = os.path.join(self.models_dir, os.path.basename(model_url).split('?')[0])
    ...
    def download_from_huggingface(self, repo_id, filename):
        ...
        try:
            ...
            self.ui.console.print(f"[magenta]Downloading {filename} from {repo_id}...[/magenta]")
    ...
    def load_model(self, model_name, context_size=2048, threads=4):
        ...
        try:
            ...
            self.ui.console.print(f"[magenta]Loading model {model_name} ({file_size_mb:.2f} MB)...[/magenta]")
            ...
            with Progress(
                ...
                def load_model_thread():
                    try:
                        ...
                        self.ui.console.print("[cyan]Attempting to load model with specified parameters...[/cyan]")
                        ...
                        self.ui.console.print(f"[yellow]First attempt failed: {str(e)}[/yellow]")
                        self.ui.console.print("[cyan]Trying with reduced context size...[/cyan]")
                        ...
                        try:
                            ...
                            self.ui.console.print(f"[yellow]Second attempt failed: {str(e2)}[/yellow]")
                            self.ui.console.print("[cyan]Trying with minimum parameters...[/cyan]")
